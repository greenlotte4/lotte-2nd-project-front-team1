export default function EditPostBoard(){
    return(
        <div className="boardContentDiv" id="boardContentDiv">
            ...
            <div id="articleEditor">
                <div className="board_write">
                    ...
                    <div className="workseditor-editor" style={{overflow: "auto;", height: 405}}>
                        <textarea data-container="TEXT" style={{display: "block", border: "none" , outline: "none" , resize: "none", width: "calc(100% - 30px)" , height: 369, padding: "20px 15px 16px"}}></textarea>
                    </div>
                </div>
